...
import DeepstackAuctionDeepstackAuctionAuction from './deepstack/auction/deepstack.auction.auction'
...
export default { 
  ...
  DeepstackAuctionDeepstackAuctionAuction: load(DeepstackAuctionDeepstackAuctionAuction, 'deepstack.auction.auction'),
